...
public static class CliUsage
{
    public static void Print()
    {
        ...
        Console.WriteLine("  -t, --type        Operation type. Supported: blc-all, json-index, chk-list, extract-type, manifest-assets-yaml, extract-from-chk, decode-ab");
        Console.WriteLine("  -o, --output      Output directory/file (required by blc-all/json-index/extract-type/manifest-assets-yaml/extract-from-chk/decode-ab).");
